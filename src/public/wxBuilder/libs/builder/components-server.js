...
Vvveb.Components.add("components/product", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/map.svg",
...
Vvveb.Components.add("components/products", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/products.svg",
...
Vvveb.Components.add("components/manufacturers", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/categories.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        nolabel:false,
        inputtype: TextInput,
...
Vvveb.Components.add("components/search", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/search.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/user", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/user.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product_gallery", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/product_gallery.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/cart", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/cart.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/checkout", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/checkout.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/filters", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/filters.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/product.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/slider", {
    ...
    image: lx_assetsURL + "/libs/builder/icons/slider.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
